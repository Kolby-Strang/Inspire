...
function authButton(user) {
  ...
  return user && user.isAuthenticated
    ? /* html */ `
    <button class="btn btn-small btn-dark text-muted selectable ms-3" onclick="app.AuthController.logout()"><i class="mdi mdi-logout f-16 text-white"></i></button>
  `
    : /* html */ `
    <button class="btn btn-dark selectable ms-3" onclick="app.AuthController.login()">login</button>
  `
}
